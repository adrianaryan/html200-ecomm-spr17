...
1. Validation Test
   • W3C Validation Test
   • Indentation, Is my code easy to read?
   • CSS   

2. Layout
   • Is my layout changes as the screen size changes? - media queries
   • Nav - line separator appear? does cart icon move to top as the menu stack?
   • Mail Form
   • Products - reflow as browser size changes

3. Performance
   • Javascript
   • Check chrome developer tool
   • Links
   • Alt tags on images
